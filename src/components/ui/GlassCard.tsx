...
export default function GlassCard({ children, className = "" }: GlassCardProps) {
    return (
        <div
            className={`relative bg-white/[0.02] backdrop-blur-2xl rounded-3xl p-8 border border-white/[0.08] shadow-[0_2px_8px_0_rgba(0,0,0,0.1)] overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-br before:from-[#6ca1ff]/[0.1] before:via-transparent before:to-[#ff91c1]/[0.1] before:pointer-events-none transition-all duration-300 hover:shadow-[0_12px_40px_0_rgba(0,0,0,0.3)] hover:-translate-y-1 ${className}`}
        >
