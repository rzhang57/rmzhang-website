...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-center gap-16 py-4 px-6 max-w-5xl mx-auto">
