...
const ProjectCard: React.FC<ProjectCardProps> = ({
    ...
    return (
        <a href={githubLink} target="_blank" rel="noopener noreferrer">
            <div
                className="scale-100 bg-opacity-70 bg-gray-100 hover:opacity-100 transition-all rounded-xl p-6 outline-none hover:outline-pink-500 duration-100 h-full hover:scale-95">
